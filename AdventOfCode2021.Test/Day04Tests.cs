...
namespace AdventOfCode2021.Test {
    ...
    public class Day04Tests {
        ...
        public void TestParseInput() {
            Assert.AreEqual(new Day04.Bingo(
                    new int[] {
                        7, 4, 9, 5, 11, 17, 23, 2, 0, 14, 21, 24, 10, 16, 13, 6, 15, 25, 12, 22, 18, 20, 8, 19, 3, 26, 1
                    },
                    new Day04.Grid[] {
                        new Day04.Grid(new int[] {
                ...
                Day04.Bingo.Parse(_sampleLines));
        }

        [Test]
        public void TestGridLineComplete() {
            Day04.Grid grid = CreateTestGrid();
        ...
        private static Day04.Grid CreateTestGrid() {
            Day04.Grid grid = new Day04.Grid(new[]
        ...
        public void TestBingoPart1() {
            Day04.Bingo bingo = Day04.Bingo.Parse(_sampleLines);
